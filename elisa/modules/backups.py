...
from elisa import LOGGER, MESSAGE_DUMP, OWNER_ID, dispatcher
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("elisa{}.backup".format(chat_id), "rb"),
        caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `elisa-Backup` is specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
