...
import elisa.modules.sql.blacklist_sql as sql
from elisa import LOGGER, dispatcher
...
from elisa.modules.warns import warn
...
def add_blacklist(update, context):
    ...
    if user_can_changeinfo(chat, user, context.bot.id) is False:
        msg.reply_text(
            "You don't have enough rights to blacklist a word!\nPerhaps__ I wish i can blacklist you."
        )
        return ""
...
def unblacklist(update, context):
    ...
    if user_can_changeinfo(chat, user, context.bot.id) is False:
        msg.reply_text(
            "You don't have enough rights to remove blacklist!\nPerhaps__ I wish i can blacklist you."
        )
        return ""
...
def blacklist_mode(update, context):
    ...
    if user_can_changeinfo(chat, user, context.bot.id) is False:
        msg.reply_text(
            "You don't have enough rights to set blacklist mode!\nPerhaps__ I wish i can blacklist you."
        )
        return ""
