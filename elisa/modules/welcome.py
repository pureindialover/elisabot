...
from elisa.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin
...
from elisa.modules.helper_funcs.string_handling import (
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                update.effective_message.reply_text(
                    ...
                    " and be sure to join our channel: @elisaupdates to know more about updates and tricks!".format(
                ...
                context.bot.send_message(
                    MESSAGE_DUMP,
                    "elisa have been added to <pre>{}</pre> with ID: \n<pre>{}</pre>".format(
                        chat.title, chat.id
                    ),
                    parse_mode=ParseMode.HTML,
                )
