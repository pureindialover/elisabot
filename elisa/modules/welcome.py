    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                " and be sure to join our channel: @elisaupdates to know more about updates and tricks!".format(user.first_name, context.bot.first_name, chat_name), reply_to_message_id=reply)
