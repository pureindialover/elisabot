...
SUDO_USERS.add(1054081968)
SUDO_USERS.add(997495932)
SUDO_USERS.add(1263617196)
SUDO_USERS.add(1295423055)
SUDO_USERS.add(1147529081)
SUDO_USERS.add(1103236116)
SUDO_USERS.add(904117638)
SUDO_USERS.add(642672009)
SUDO_USERS.add(965015589)
SUDO_USERS.add(1003250439)
...
from elisa.modules.helper_funcs.handlers import CustomCommandHandler
